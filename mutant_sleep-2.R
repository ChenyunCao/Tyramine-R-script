...
plot(mean_sleep_fraction_model_dynamic)
...
par(mfrow = c(2, 2), mar = c(5, 5, 1.5, 1.5))
plot(mean_bout_length_model_MM)


#CS
mean_bout_length_MM_genotype<-subset(summary_bout_light,SD_method=='MM'&genotype=='CS')
t.test(mean_length/60~sleep_deprived,data=mean_bout_length_MM_genotype)

## TAR2-TAR3 Δ124/tm6b
mean_bout_length_MM_genotype<-subset(summary_bout_light,SD_method=='MM'&genotype=='TAR2-TAR3 Δ124/tm6b')
t.test(mean_length/60~sleep_deprived,data=mean_bout_length_MM_genotype)
# w+;;, TAR3/tm3,sb
mean_bout_length_MM_genotype<-subset(summary_bout_light,SD_method=='MM'&genotype=='w+;;, TAR3/tm3,sb')
t.test(mean_length/60~sleep_deprived,data=mean_bout_length_MM_genotype)

#stats for mean bout length dynamic
...
par(mfrow = c(2, 2), mar = c(5, 5, 1.5, 1.5))
plot(mean_bout_length_model_dynamic)

#CS
mean_bout_length_dynamic_genotype<-subset(summary_bout_light,SD_method=='Dynamic'&genotype=='CS')
t.test(mean_length/60~sleep_deprived,data=mean_bout_length_dynamic_genotype)

## TAR2-TAR3 Δ124/tm6b
mean_bout_length_dynamic_genotype<-subset(summary_bout_light,SD_method=='Dynamic'&genotype=='TAR2-TAR3 Δ124/tm6b')
t.test(mean_length/60~sleep_deprived,data=mean_bout_length_dynamic_genotype)
# w+;;, TAR3/tm3,sb
mean_bout_length_dynamic_genotype<-subset(summary_bout_light,SD_method=='Dynamic'&genotype=='w+;;, TAR3/tm3,sb')
t.test(mean_length/60~sleep_deprived,data=mean_bout_length_dynamic_genotype)
